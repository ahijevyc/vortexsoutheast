...
parser = argparse.ArgumentParser(description='given stormtime file, return storm list for NARR_composite.py with filtered times of diurnal cycle', 
...
with open(ifile,'r') as f:
    for line in f:
        ...
        narrtimes = pd.date_range(start=start, end=start+pd.Timedelta(1,unit="day"), freq='3H', inclusive="left")
...
ofile = os.path.join(os.getenv("TMPDIR"),base+"."+"".join(zero_padded_hours)+"z.txt")
